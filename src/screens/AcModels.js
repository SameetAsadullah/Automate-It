        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.tableContainer}>
                ...
                <View style={styles.tableElement1}>
                    ...
                    >
                        <Text style={styles.tableText}>LG</Text>
                    </ImageBackground>
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.tableElement1}>
                    <TouchableOpacity>
                    <ImageBackground
                        source={require("./images/Haier.png")}
                        resizeMode="contain"
                        style={{width: 115, height: 135, marginLeft: 17}}
                        // imageStyle={{tintColor: "#FFFFFF"}}
                    >
                        <Text style={styles.tableText}>Haier</Text>
                    </ImageBackground>
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.tableElement2}>
                    ...
                    <ImageBackground
                        source={require("./images/Samsung.png")}
                        resizeMode="contain"
                        style={{width: 115, height: 70, marginLeft: 17}}
                        // imageStyle={}
                    >
                        <Text style={styles.tableText1}>Samsung</Text>
                    </ImageBackground>
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.tableElement2}>
                    <TouchableOpacity>
                    <ImageBackground
                        source={require("./images/Orient.png")}
                        resizeMode="contain"
                        style={{width: 120, height: 128, marginLeft: 17}}
                        // imageStyle={{tintColor: "#FFFFFF"}}
                    >
                        <Text style={styles.tableText}>Orient</Text>
                    </ImageBackground>
                    </TouchableOpacity>
                </View>
